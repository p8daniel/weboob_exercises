...
__all__ = ['Fakebank_v2Browser']


class Fakebank_v2Browser(LoginBrowser, PagesBrowser):
    BASEURL = 'https://people.lan.budget-insight.com/'

    login = URL('/~ntome/fake_bank.wsgi/v2/#login', LoginPage)
    account_url = URL(r'https://people.lan.budget-insight.com/~ntome/fake_bank.wsgi/v2/accounts/(?P<id>\d+).json', HistoryPage)
    home = URL('/~ntome/fake_bank.wsgi/v2/$', IndexPage)
    # account_url = URL(r'https://people.lan.budget-insight.com/~ntome/fake_bank.wsgi/v2/?#history:(?P<id>\d+)', HistoryPage)
    # account_url = URL(r'https://people.lan.budget-insight.com/~ntome/fake_bank.wsgi/v2/', HistoryPage)
    ...
    accounts = URL(r'https://people.lan.budget-insight.com/~ntome/fake_bank.wsgi/v2/accounts.json', ListPage)
